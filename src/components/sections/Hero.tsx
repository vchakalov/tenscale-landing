...
export function Hero() {
  return (
    <div className="flex flex-col items-center justify-center w-full px-4">
      <h1 className="font-[family-name:var(--font-pt-serif)] pb-5 text-[48px] sm:text-[88px] max-w-5xl text-center leading-[100%] font-light sm:font-light">
        Personalized AI marketing funnels.
      </h1>
      <p className="font-[family-name:var(--font-inter)] font-normal text-[14px] sm:text-[16px] leading-[18px] sm:leading-[26px] pb-10 sm:pb-14 text-center max-w-xl text-foreground-secondary">
      ...
      <div className="relative mb-10 sm:mb-14 space-y-4">
        ...
        <div className="relative flex flex-row items-center justify-center gap-1">
          <div className="font-[family-name:var(--font-inter)] font-normal text-[14px] sm:text-[16px] leading-[18px] sm:leading-[26px] text-foreground-secondary">
      ...
      <div className="flex flex-row flex-wrap items-center justify-center gap-2 sm:gap-4 mb-8 -mx-2">
        <button className="bg-white text-black px-3 py-2 rounded-full border border-gray-300 hover:bg-brand-lilac hover:border-brand-lilac cursor-pointer transition-colors group flex flex-row flex-nowrap items-center gap-2 no-shrink text-sm font-medium">
          <svg
            ...
            aria-hidden="true"
            data-slot="icon"
            className="inline-block flex-grow-0 flex-shrink-0 text-inherit w-icon-xs h-icon-xs stroke-[#0158ff] group-hover:stroke-black transition-all"
          >
        ...
        <button className="bg-white text-black px-3 py-2 rounded-full border border-gray-300 hover:bg-brand-lilac hover:border-brand-lilac cursor-pointer transition-colors group flex flex-row flex-nowrap items-center gap-2 no-shrink text-sm font-medium">
          <svg
            viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg"
            className="fill-[#0158ff] group-hover:fill-black transition-all size-4 sm:size-5"
          >
      ...
      <div className="w-full aspect-[16/10] sm:aspect-[16/6] grid items-start max-w-7xl overflow-hidden">
        <div className="row-1 col-1 grid grid-cols-1 relative w-full aspect-[16/9] sm:aspect-[16/10]">
          <div className="grid gap-2" style={{ gridTemplateColumns: '2fr 1fr 2fr' }}>
            <div className="h-full w-full bg-[linear-gradient(to_right,#EDEAE2,#DCE4F5,#B9CBF0,#8FAEE9)]"></div>
            <div className="h-full w-full bg-[linear-gradient(to_right,#EDEAE2,#DCE4F5,#B9CBF0,#8FAEE9)]"></div>
            <div className="h-full w-full bg-[linear-gradient(to_right,#EDEAE2,#DCE4F5,#B9CBF0,#8FAEE9)]"></div>
          </div>
          <div className="grid gap-2" style={{ gridTemplateColumns: '1fr 2fr 1fr 3fr 1fr' }}>
            <div className="h-full w-full bg-[linear-gradient(to_left,#EDEAE2,#DCE4F5,#B9CBF0,#8FAEE9)]"></div>
            <div className="h-full w-full bg-[linear-gradient(to_left,#EDEAE2,#DCE4F5,#B9CBF0,#8FAEE9)]"></div>
            <div className="h-full w-full bg-[linear-gradient(to_left,#EDEAE2,#DCE4F5,#B9CBF0,#8FAEE9)]"></div>
            <div className="h-full w-full bg-[linear-gradient(to_left,#EDEAE2,#DCE4F5,#B9CBF0,#8FAEE9)]"></div>
            <div className="h-full w-full bg-[linear-gradient(to_left,#EDEAE2,#DCE4F5,#B9CBF0,#8FAEE9)]"></div>
        ...
        <div className="relative row-1 col-1 px-4 pt-8 sm:pt-16">
          <img
            ...
            width="2752"
            height="1536"
            className="rounded-t-2xl border border-[#E7E2D6] shadow-[0_40px_90px_-40px_rgba(17,17,17,0.35)] mx-auto w-full max-w-5xl h-auto"

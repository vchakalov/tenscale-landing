  ...
  return (
    <section className="section-full" id="pricing">
      <div className="container-default">
        <div className="flex flex-col items-start relative w-full rounded-3xl overflow-hidden border border-solid border-[#2d2d2d0d] bg-[linear-gradient(179deg,rgba(255,255,255,1)_0%,rgba(253,231,233,1)_84%)]">
          ...
          <div className="flex flex-col items-start gap-12 lg:gap-20 pt-16 lg:pt-20 pb-16 lg:pb-[88px] px-4 lg:px-16 relative self-stretch w-full flex-[0_0_auto]">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 relative self-stretch w-full">
              ...
              <div className="flex flex-col items-center gap-2 pt-2 pb-0 px-0 relative flex-1 grow order-1 lg:order-2 rounded-3xl shadow-xl bg-[linear-gradient(108deg,rgba(17,17,17,1)_0%,rgba(17,17,17,1)_36%,rgba(253,176,184,1)_100%)]">
                <div className="font-[family-name:var(--font-geist-sans)] text-[14px] sm:text-[16px] leading-[18px] sm:leading-[26px] font-medium text-white">
                  Step 2
                </div>
                <div className="flex items-start justify-center grow-1 gap-2 relative self-stretch w-full flex-[0_0_auto] rounded-3xl overflow-hidden bg-white">
                  <div className="rounded-xl border border-[#2d2d2d0d] flex flex-col items-start gap-6 p-6 flex-1 grow relative h-full border-none bg-linear-[25deg,white_70%,transparent_140%]">
                    <div className="flex flex-col p-0 space-y-1 z-10">
                      <div className="font-[family-name:var(--font-geist-sans)] font-medium text-[18px] sm:text-[24px] leading-[26px] sm:leading-[32px] relative self-stretch text-gray-500">
                        We build your engine
                      </div>
                    </div>
                    <div className="p-0 flex flex-col flex-1 self-stretch w-full z-10">
                      <div className="font-[family-name:var(--font-geist-sans)] font-medium text-[16px] sm:text-[18px] leading-[20px] sm:leading-[28px] !font-normal relative self-stretch text-gray-600">
              ...
              {/* Step 1 - Book a call */}
              <div className="border border-solid border-[#2d2d2d0d] mt-0 lg:mt-10 flex flex-col items-start gap-6 p-6 flex-1 grow order-2 lg:order-1 bg-white rounded-3xl shadow-xl">
                <div className="flex flex-col p-0 space-y-1 z-10">
                  <div className="font-[family-name:var(--font-geist-sans)] font-medium text-[18px] sm:text-[24px] leading-[26px] sm:leading-[32px] relative self-stretch text-gray-500">
                    Book a call
                  </div>
              ...
              <div className="border border-solid border-[#2d2d2d0d] mt-0 lg:mt-10 flex flex-col items-start gap-6 p-6 flex-1 grow order-3 lg:order-3 bg-white rounded-3xl shadow-xl">
                <div className="flex flex-col p-0 space-y-1 z-10">
                  <div className="font-[family-name:var(--font-geist-sans)] font-medium text-[18px] sm:text-[24px] leading-[26px] sm:leading-[32px] relative self-stretch text-gray-500">

          ...
          <div className="flex flex-col items-start gap-6 w-full">
            <div className="flex flex-col items-start gap-6 w-full">
              <div className="flex flex-col items-start gap-4 pl-2 pr-0 py-0 w-full">
                <h3 className="font-[family-name:var(--font-gelica)] text-[20px] sm:text-[24px] leading-[24px] sm:leading-[40px] w-full font-light">
                  Describe your offer
                </h3>
              ...
              <div className="relative">
                <img
                  ...
                  alt=""
                  className="rounded-3xl border border-solid border-[#2d2d2d0d] w-full h-auto"
                />
              </div>
            </div>
          </div>

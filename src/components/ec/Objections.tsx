...
function ObjectionRow({
  ...
  return (
    <div className="border-t border-[#0c0a08] pt-[36px] max-[800px]:pt-[22px]">
      <div className="flex items-start gap-[28px]">
        <span className="flex h-[72px] w-[72px] shrink-0 items-center justify-center rounded-full bg-[#0c0a08] font-[family-name:var(--font-pt-serif)] text-[28px] font-bold text-[#f4f2f0] max-[800px]:hidden">
          {String(index + 1).padStart(2, "0")}
        </span>

        <div className="min-w-0">
          <h3 className="font-[family-name:var(--font-pt-serif)] text-[30px] leading-[38px] font-bold text-[#0c0a08] max-[800px]:text-[24px] max-[800px]:leading-[32px]">
          ...
          {answer.map((paragraph, i) => (
            <p
              key={paragraph}
              className={`${i === 0 ? "mt-[16px]" : "mt-[14px]"} font-[family-name:var(--font-inter)] text-[17px] leading-[27px] font-normal text-[rgba(12,10,8,0.8)] max-[800px]:text-[17px] max-[800px]:leading-[27px]`}
            >
              {paragraph}
            </p>
          ))}
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[905px]">
        <h2 className="text-center font-[family-name:var(--font-pt-serif)] text-[48px] leading-[56px] font-bold text-[#0c0a08] max-[800px]:text-[36px] max-[800px]:leading-[42px]">

  ...
  return (
    <figure className={className}>
      {/*
        ...
        reads as a hot rectangle on the #0c0a08 card without it. Desaturating
      ...
      */}
      <div className="relative overflow-hidden rounded-[8px] border border-[rgba(244,242,240,0.15)]">
    ...
    <>
      <section className="mt-[170px] hidden p-0 min-[801px]:block">
        <div className="mx-auto w-full max-w-[1120px]">
          <div className="rounded-[12px] bg-[#0c0a08] py-0 pr-[200px] pl-[100px]">
            <blockquote className="max-w-[820px] pt-[97px] text-left font-[family-name:var(--font-pt-serif)] text-[68px] leading-[84px] font-bold text-[#f4f2f0]">
              {PULL_QUOTE}
            </blockquote>

            <ClientPhoto
              className="mt-[67px] w-[820px]"
              captionClass="font-[family-name:var(--font-inter)] text-[14px] leading-[20px] font-normal text-[rgba(244,242,240,0.6)]"
            />
            ...
            <div className="mt-[73px] flex max-w-[820px] flex-col gap-[41px]">
              {PARAGRAPHS.map((paragraph) => (
                <p
                  key={paragraph}
                  className="text-left font-[family-name:var(--font-poppins)] text-[22px] leading-[36px] font-normal text-[rgba(244,242,240,0.6)]"
                >
                  {paragraph}
                </p>
              ))}
              <p className="text-left font-[family-name:var(--font-pt-serif)] text-[28px] leading-[36px] font-bold text-[#f4f2f0]">
                {RESULTS_HEADING}
              </p>
            ...
            <div className="mt-[52px] flex items-center gap-[20px] pb-[100px]">
              <AttributionMark />
              <span className="font-[family-name:var(--font-poppins)] text-[20px] leading-[30px] font-normal text-[rgba(244,242,240,0.6)]">
                {ATTRIBUTION}
              </span>
            </div>
          </div>
      ...
      <section className="mt-[75px] p-0 max-[800px]:block min-[801px]:hidden">
        <div className="mx-[15px]">
          <div className="rounded-[7px] bg-[#0c0a08] px-[20px] py-[50px]">
            <blockquote className="text-left font-[family-name:var(--font-pt-serif)] text-[28px] leading-[34px] font-bold text-[#f4f2f0]">
              {PULL_QUOTE}
            </blockquote>

            <ClientPhoto
              className="mx-auto mt-[32px] w-[320px]"
              captionClass="font-[family-name:var(--font-inter)] text-[13px] leading-[18px] font-normal text-[rgba(244,242,240,0.5)]"
            />
            ...
            <div className="mt-[32px] flex flex-col gap-[24px]">
              {PARAGRAPHS.map((paragraph) => (
                <p
                  key={paragraph}
                  className="text-left font-[family-name:var(--font-inter)] text-[16px] leading-[22px] font-normal text-[rgba(244,242,240,0.4)]"
                >
                  {paragraph}
                </p>
              ))}
              <p className="text-left font-[family-name:var(--font-pt-serif)] text-[20px] leading-[26px] font-bold text-[#f4f2f0]">
                {RESULTS_HEADING}
              </p>
              {RESULTS.map((paragraph) => (
                <p
            ...
            <div className="mt-[32px] flex items-center gap-[14px]">
              <AttributionMark />
              <span className="font-[family-name:var(--font-inter)] text-[16px] leading-[22px] font-normal text-[rgba(244,242,240,0.6)]">
                {ATTRIBUTION}
              </span>
            </div>

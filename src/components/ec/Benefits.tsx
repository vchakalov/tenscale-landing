...
function AnglesMark({ className }: { className: string }) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden="true">
      <circle cx="14" cy="32" r="7" fill="#EDE8DF" />
      <path
        ...
        fill="none"
      />
      <circle cx="49" cy="14" r="6" fill="#EDE8DF" />
      <circle cx="49" cy="32" r="6" fill="#EDE8DF" />
      <circle cx="49" cy="50" r="6" fill="#EDE8DF" />
    </svg>
  );
}
...
function MatchMark({ className }: { className: string }) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden="true">
      <rect x="6" y="14" width="22" height="30" rx="3" fill="#EDE8DF" />
      <rect x="36" y="14" width="22" height="30" rx="3" fill="#EDE8DF" />
      <path
        d="M28 29h8"
        stroke="#EDE8DF"
        strokeWidth="3.5"
...
function RulesMark({ className }: { className: string }) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden="true">
      <path d="M10 46h8v10h-8zM26 34h8v22h-8z" fill="#EDE8DF" />
      <path d="M42 18h8v38h-8z" fill="#EDE8DF" />
      <path
...
function BenefitCard({
  ...
  return (
    <div className="flex flex-col items-start text-left">
      <div className="flex h-[92px] w-[92px] items-center justify-center rounded-full border-[1.5px] border-[#EDE8DF] bg-[#0A0908] transition-[box-shadow,transform] duration-200 hover:-translate-y-px hover:shadow-[8px_10px_0_0_rgba(237,232,223,0.12)]">
      ...
      <p className="mt-[12px] font-[family-name:var(--font-inter)] text-[clamp(15px,1.12vw,19px)] leading-[1.6] font-normal text-[rgba(237,232,223,0.78)]">
        {hook && (
          <span className="font-semibold text-[#C6A660]">{hook} </span>
        )}
        {body}
      </p>
    </div>
...
function BenefitRow({
  ...
  return (
    <div className="flex items-start gap-[16px] border-t border-[rgba(237,232,223,0.16)] pt-[22px]">
      <span className="flex h-[46px] w-[46px] shrink-0 items-center justify-center rounded-full border-[1.5px] border-[#EDE8DF]">
    ...
    <>
      ...
      <div className="max-[800px]:block min-[801px]:hidden">
        <section className="mt-[65px] px-[5px] py-[20px]">
          <h2 className="text-center font-[family-name:var(--font-pt-serif)] text-[36px] leading-[42px] font-bold text-[#EDE8DF]">
            What Changes
            <br />
            You Will Notice.
          </h2>

...
function Skeleton() {
  return (
    <div
      aria-hidden="true"
      className="absolute inset-0 animate-pulse rounded-[12px] bg-[rgba(12,10,8,0.05)] p-[22px]"
    >
      <div className="h-[34px] w-full rounded-[8px] bg-[rgba(12,10,8,0.06)]" />
      <div className="mt-[20px] h-[22px] w-[55%] rounded-[6px] bg-[rgba(12,10,8,0.06)]" />
      <div className="mt-[12px] h-[22px] w-[38%] rounded-[6px] bg-[rgba(12,10,8,0.06)]" />
      <div className="mt-[28px] h-[44px] w-[62%] rounded-[8px] bg-[rgba(12,10,8,0.06)]" />
    </div>
  );
}
  ...
  return (
    <div
      className={
        state === "hidden"
          ? "hidden"
          : `relative overflow-hidden rounded-[16px] border border-[#e5e7eb] bg-[#ffffff] p-[clamp(10px,1vw,18px)] ${className}`
      }

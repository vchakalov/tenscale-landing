...
function Eyebrow({ className }: { className: string }) {
  return (
    <p className={className}>
      Owners of{" "}
      <span className="text-[#0c0a08] whitespace-nowrap">$1M&ndash;$4M</span>{" "}
      Lead Gen Agencies
    </p>
  );
}
...
function Headline({ className }: { className: string }) {
  return (
    <h1 className={className}>
      ...
      <span className="text-[#0c0a08] whitespace-nowrap">
        Or You Don&apos;t Pay.
      </span>
    </h1>
  );
  ...
  return (
    <>
      ...
      {/* Navy, not the accent. The blue is spent on the headline's closing
          ...
          fold read as busy. */}
      <strong className="font-semibold text-[#0c0a08]">
...
export function HeroFold() {
  return (
    <>
      ...
      */}
      <section className="hidden bg-[#f4f2f0] px-[40px] pt-[20px] pb-[16px] min-[801px]:block">
        <div className="relative mx-auto w-full max-w-[1560px] text-center">
          <Eyebrow className="font-[family-name:var(--font-pt-serif)] text-[clamp(19px,1.78vw,34px)] leading-[1.35] font-bold text-[#0c0a08]" />

          <Headline className="mx-auto mt-[18px] max-w-[min(1560px,92vw)] text-balance font-[family-name:var(--font-libre-baskerville)] text-[clamp(30px,2.95vw,56px)] leading-[1.18] font-bold text-[#0c0a08]" />

          <p className="mx-auto mt-[20px] max-w-[min(1400px,84vw)] text-pretty font-[family-name:var(--font-poppins)] text-[clamp(16px,1.1vw,21px)] leading-[1.55] font-normal text-[#0c0a08]">
            <SubheadCopy />
          </p>
          ...
          <div className="mt-[24px]">
            ...
            <div className="mt-[18px]">
              <ProofStats
                ...
                valueClass="font-[family-name:var(--font-libre-baskerville)] text-[clamp(22px,1.7vw,31px)] leading-[1.28] font-bold text-[#0c0a08]"
                labelClass="mt-[3px] font-[family-name:var(--font-inter)] text-[clamp(12px,0.95vw,16px)] leading-[1.4] text-[rgba(12,10,8,0.65)]"
              />
            </div>
          </div>
        </div>
      ...
      */}
      <section className="flex flex-col items-center bg-[#f4f2f0] px-[14px] pt-[24px] pb-[12px] text-center min-[801px]:hidden">
        <Eyebrow className="text-balance font-[family-name:var(--font-pt-serif)] text-[18px] leading-[1.4] font-bold text-[#0c0a08]" />

        <Headline className="mt-[14px] text-balance font-[family-name:var(--font-pt-serif)] text-[29px] leading-[1.2] font-bold text-[#0c0a08]" />

        <p className="mt-[20px] text-pretty font-[family-name:var(--font-inter)] text-[17px] leading-[26px] font-normal text-[#0c0a08]">
          <SubheadCopy />
        </p>
        ...
        <div className="mt-[20px]" data-hero-cta>
          ...
          <div className="mt-[18px] w-full">
            <ProofStats
              gapClass="gap-[22px]"
              valueClass="font-[family-name:var(--font-pt-serif)] text-[19px] leading-[25px] font-bold text-[#0c0a08]"
              labelClass="mt-[2px] font-[family-name:var(--font-inter)] text-[11px] leading-[15px] text-[rgba(12,10,8,0.65)]"
            />
          </div>
        </div>
      </section>

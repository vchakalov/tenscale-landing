...
function Headline({ className }: { className: string }) {
  return (
    <h1 className={className}>
      ...
      <br />
      And We Replace It{" "}
      <span className="text-[#FFD100]">With AI</span>
    </h1>
  );
}
...
export function Hero() {
  return (
    <>
      <section
        className={cn(
          "hidden bg-[#0B0B0B] px-[40px] pt-[63px] pb-[20px] min-[801px]:flex",
          "mt-[20px]",
        )}
      >
        <div className="mx-auto w-full max-w-[1120px] text-center">
          <Headline className="font-[family-name:var(--font-libre-baskerville)] text-[110px] leading-[135px] font-bold text-[#F5F5F5]" />

          <p className="mx-auto mt-[54px] max-w-[913px] font-[family-name:var(--font-poppins)] text-[22px] leading-[32px] font-normal text-[#F5F5F5]">
            <SubheadCopy />
          </p>

          <div className="mt-[90px]">
            <CtaButton variant="blueRaised">Let&apos;s Talk</CtaButton>
            <p className="mt-[16px] font-[family-name:var(--font-pt-serif)] text-[14px] leading-[20px] text-[#F5F5F5]">
              A fit call. If we can help, we run the assessment.
            </p>
          </div>

          <p className="mt-[190px] font-[family-name:var(--font-pt-serif)] text-[14px] leading-[20px] font-bold text-[#F5F5F5]">
      ...
      <div className="block min-[801px]:hidden">
        <section className="mt-[35px] flex flex-col items-center bg-[#0B0B0B] px-[5px] pt-[7px] pb-[12px] text-center">
          <Headline className="max-w-[340px] font-[family-name:var(--font-pt-serif)] text-[54px] leading-[56px] font-bold text-[#F5F5F5]" />

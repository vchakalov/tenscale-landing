          ...
          <div key={item.question}>
            ...
            >
              <button
                ...
                className={cn(
                  "flex w-full cursor-pointer items-center justify-between border-0 bg-transparent p-0 text-left text-[#F5F5F5]",
                  styles.question,
                )}
              >
                    ...
                    <ul className="mt-[24px] grid grid-cols-2 gap-x-[40px] gap-y-[14px] max-[800px]:mt-[22px] max-[800px]:grid-cols-1 max-[800px]:gap-y-[12px]">
                      {item.list.map((line) => (
                        <li key={line} className="flex gap-[10px]">
                          <span
                            aria-hidden
                            className="mt-[11px] h-[5px] w-[5px] shrink-0 rounded-full bg-[#FFD100] max-[800px]:mt-[8px]"
                          />
                          <span>{line}</span>
                        </li>
                      ))}
                  ...
                  {item.footerLink && (
                    <p className="mt-[24px] max-[800px]:mt-[22px]">
                      <Link
                        ...
                        className="text-[#FFD100] underline underline-offset-[3px]"
                      >
      ...
      <div className="mt-[200px] hidden min-[801px]:block">
        <section className="px-0 pt-[21px] pb-0">
          <div className="mx-auto max-w-[1120px]">
            <h2 className="text-center font-[family-name:var(--font-pt-serif)] text-[42px] leading-[48px] font-normal text-[#F5F5F5]">

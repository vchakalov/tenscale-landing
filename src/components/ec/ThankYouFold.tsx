...
function Headline({ className }: { className: string }) {
  return (
    <h1 className={className}>
      Congratulations.
      <br />
      <span className="text-[#C6A660]">Your Call Is Booked.</span>
    </h1>
  );
}
...
export function ThankYouFold() {
  return (
    <>
      {/* Desktop */}
      <section className="hidden bg-[#0A0908] px-[40px] pt-[22px] pb-[26px] min-[801px]:block">
        <div className="relative mx-auto w-full max-w-[1560px] text-center">
          <Headline className="mx-auto text-balance font-[family-name:var(--font-libre-baskerville)] text-[clamp(29px,2.7vw,50px)] leading-[1.16] font-bold text-[#EDE8DF]" />

          <p className="mx-auto mt-[24px] max-w-[min(900px,72vw)] text-pretty font-[family-name:var(--font-poppins)] text-[clamp(16px,1.1vw,21px)] leading-[1.55] font-normal text-[#EDE8DF]">
            <SubheadCopy />
          </p>
      ...
      <section className="flex flex-col items-center bg-[#0A0908] px-[14px] pt-[24px] pb-[12px] text-center min-[801px]:hidden">
        <Headline className="text-balance font-[family-name:var(--font-pt-serif)] text-[30px] leading-[1.2] font-bold text-[#EDE8DF]" />

        <p className="mt-[16px] text-pretty font-[family-name:var(--font-inter)] text-[17px] leading-[26px] font-normal text-[#EDE8DF]">
          <SubheadCopy />
        </p>

    ...
    <div className="mx-auto grid max-w-[900px] grid-cols-3 gap-[24px] max-[800px]:gap-[14px]">
      {PROOF_STATS.map((stat) => (
        <div key={stat.value} className="text-center">
          <p className="font-[family-name:var(--font-libre-baskerville)] text-[44px] leading-[52px] font-bold text-[#EDE8DF] max-[800px]:text-[26px] max-[800px]:leading-[32px]">
            {stat.value}
          </p>
          <p className="mt-[6px] font-[family-name:var(--font-inter)] text-[14px] leading-[21px] text-[rgba(237,232,223,0.7)] max-[800px]:text-[12px] max-[800px]:leading-[17px]">
            {stat.label}
          </p>
        </div>
      ))}
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[1120px]">
        ...
        <div className="mt-[56px] rounded-[20px] bg-[#EDE8DF] px-[80px] py-[72px] max-[800px]:mt-[40px] max-[800px]:px-[24px] max-[800px]:py-[40px]">
          <NoticePill />

          <h2 className="mt-[28px] font-[family-name:var(--font-libre-baskerville)] text-[46px] leading-[58px] font-bold text-[#0A0908] max-[800px]:text-[30px] max-[800px]:leading-[38px]">
            See It Run On <span className="underline">Your Own</span> Accounts
          </h2>

          <p className="mt-[20px] max-w-[640px] font-[family-name:var(--font-poppins)] text-[19px] leading-[30px] font-normal text-[rgba(10,9,8,0.6)] max-[800px]:text-[18px] max-[800px]:leading-[28px]">
          ...
          <p className="mt-[24px] max-w-[640px] border-l-[3px] border-[#C6A660] pl-[18px] font-[family-name:var(--font-pt-serif)] text-[18px] leading-[28px] font-bold text-[#0A0908] max-[800px]:text-[18px] max-[800px]:leading-[28px]">
          ...
          <div className="mt-[40px]">
            ...
            <p className="mt-[14px] font-[family-name:var(--font-inter)] text-[13px] leading-[19px] font-bold text-[rgba(10,9,8,0.6)]">
